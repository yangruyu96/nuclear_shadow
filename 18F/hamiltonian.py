...
def V_data(J,T,a,b,c,d):
    ...
    if J == 0 and T == 1:
        if a==5 and b==5 and c == 5 and d==5:
            return -2.4796
        if a == 5 and b == 5 and c == 3 and d == 3:
            return -3.5693
        if a == 5 and b == 5 and c == 1 and d == 1:
            return -1.1572
        ...
        if a == 1 and b == 1 and c == 1 and d == 1:
            ...
            return 0
    if J == 1 and T == 1:
        if a==5 and b==3 and c==5 and d==3:
            return 0.2510
        if a == 5 and b == 3 and c == 3 and d == 1:
            return 0.0736
    ...
    if J == 2 and T == 1:
        if a == 5 and b == 5 and c == 5 and d == 5:
            return -0.9899
        if a == 5 and b == 5 and c == 5 and d == 3:
            return -0.3092
        if a == 5 and b == 5 and c == 5 and d == 1:
            return -0.7746
        if a == 5 and b == 5 and c == 3 and d == 3:
            return -1.1335
        if a == 5 and b == 5 and c == 3 and d == 1:
            return 0.8901
        if a == 5 and b == 3 and c == 5 and d == 3:
            return 0.2248
        if a == 5 and b == 3 and c == 5 and d == 1:
            return 0.1022
        if a == 5 and b == 3 and c == 3 and d == 3:
            return -0.5208
        if a == 5 and b == 3 and c == 3 and d == 1:
            return 0.2811
        if a == 5 and b == 1 and c == 5 and d == 1:
            return -0.9039
        if a == 5 and b == 1 and c == 3 and d == 3:
            return -0.5542
        if a == 5 and b == 1 and c == 3 and d == 1:
            return 1.7072
        if a == 3 and b == 3 and c == 3 and d == 3:
            return -0.1570
    ...
    if J == 1 and T == 0:
        ...
        if a == 5 and b == 3 and c == 3 and d == 1:
            return 1.5511
        if a == 5 and b == 3 and c == 1 and d == 1:
            return 1.9021
        if a == 3 and b == 3 and c == 3 and d == 3:
            return -1.4927
        if a == 3 and b == 3 and c == 3 and d == 1:
...
for a in tqdm(range(0,24,1)):
    for b in range(a+1,24,1):
        for d in range(0,24,1):
            for c in range(d+1,24,1):
                x1 = anti_index(a)
                x2 = anti_index(b)
                x4 = anti_index(d)
                x3 = anti_index(c)
...
# print(H)
# print(H_V)
np.savetxt('matrix_Hamiltonian_19F_628_50',H,fmt = '%s')
# print(H.shape)
#
