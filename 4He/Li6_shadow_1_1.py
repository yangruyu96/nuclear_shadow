...
state_shadow = np.loadtxt('shadow_80_1k_Li6_1_94_new',dtype=complex)
for j in tqdm(range(81,600,1)):
    for i in range(0,1000):
        state_shadow = (state_shadow + shadow(6,H,1,index = 1)/1000)
    if j % 10 == 0:
        np.savetxt('shadow_{}_1k_Li6_1_94_new'.format(j),state_shadow)
#
# number = 10
# simulator = QasmSimulator()
# circuit = QuantumCircuit(number, number)
