...
def state(i):
    state = np.loadtxt('shadow_0_1w_Li8_{}'.format(i),dtype=complex) #+ np.loadtxt('shadow_{}_200_Li6'.format(i),dtype=complex) + np.loadtxt('shadow_{}_300_Li6'.format(i),dtype=complex)\
