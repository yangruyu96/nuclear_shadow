...
def state(i,n,m=0):
        state = np.loadtxt('shadow_{}_1k_Li8_{}_94_new'.format(n,i),dtype=complex)# - np.loadtxt('shadow_{}_1k_Li8_{}_94_new'.format(m-n,i),dtype=complex)  # + np.loadtxt('shadow_{}_1_He6'.format(i),dtype=complex) * 10000
...
for scale in range(8,29):
    for n in range(10,20,10):
        ...
        y_value.append((math.log(abs(1/(min(a) - y_ideal) ))))
