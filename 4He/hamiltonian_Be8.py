...
for d in range(0,12,2):
    for c in range(1,12,2):
        for f in range(d+2,12,2):
            for h in range(c+2,12,2):
                state_right_list.append([Jordan_creation(int(h)),Jordan_creation(int(f)),Jordan_creation(int(c)),Jordan_creation(int(d))])

for a in tqdm(range(0,12,2)):
    for b in range(1,12,2):
        for e in range(a+2,12,2):
            for k in range(b+2,12,2):
                state_left_list.append([Jordan_annilation(int(a)),Jordan_annilation(int(b)),Jordan_annilation(int(e)),Jordan_annilation(k)])
...
# print(H)
# print(H_V)
np.savetxt('matrix_Hamiltonian_Be8',H,fmt = '%s')
# print(H.shape)
#
